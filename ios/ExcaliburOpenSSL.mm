...
@implementation ExcaliburOpenSSL

+ (NSString *)privateDecryptWith:(NSString *)key passphrase:(NSString *)passphrase data:(NSString *)data format:(NSString *)format
{
    return [NSString stringWithUTF8String:excalibur_crypto_openssl::private_decrypt([key UTF8String], [passphrase UTF8String], [data UTF8String], [format UTF8String]).c_str()];
}

+ (NSString *)privateEncryptWith:(NSString *)key passphrase:(NSString *)passphrase data:(NSString *)data format:(NSString *)format
{
    return [NSString stringWithUTF8String:excalibur_crypto_openssl::private_encrypt([key UTF8String], [passphrase UTF8String], [data UTF8String], [format UTF8String]).c_str()];
}

+ (NSString *)publicEncryptWith:(NSString *)cert data:(NSString *)data format:(NSString *)format
{
    return [NSString stringWithUTF8String:excalibur_crypto_openssl::public_encrypt([cert UTF8String], [data UTF8String], [format UTF8String]).c_str()];
}

+ (NSString *)aesEncryptWith:(NSString *)key data:(NSString *)data auth:(NSString *)auth iv:(NSString *)iv
{
    return [NSString stringWithUTF8String:excalibur_crypto_openssl::aes_gcm_encrypt([key UTF8String], [data UTF8String], [auth UTF8String], [iv UTF8String]).c_str()];
}

+ (NSString *)aesDecryptWith:(NSString *)key data:(NSString *)data auth:(NSString *)auth iv:(NSString *)iv
{
    return [NSString stringWithUTF8String:excalibur_crypto_openssl::aes_gcm_decrypt([key UTF8String], [data UTF8String], [auth UTF8String], [iv UTF8String]).c_str()];
}

+ (NSString *)p12With:(NSString *)key cert:(NSString *)cert passphrase:(NSString *)passphrase
{
    return [NSString stringWithUTF8String:excalibur_crypto_openssl::p12([key UTF8String], [cert UTF8String], [passphrase UTF8String]).c_str()];
}

+ (NSString *)pbkdf2With:(NSString *)pass salt:(NSString *)salt iterations:(int)iterations
{
    return [NSString stringWithUTF8String:crypto::pbkdf2([pass UTF8String], [salt UTF8String], iterations).c_str()];
}

+ (NSString *)sha256With:(NSString *)data
{
    return [NSString stringWithUTF8String:crypto::sha256([data UTF8String]).c_str()];
}

+ (NSString *)sha512With:(NSString *)data
{
    return [NSString stringWithUTF8String:crypto::sha512([data UTF8String]).c_str()];
}

+ (NSString *)hexToBase64With:(NSString *)data
{
    crypto::buffer hex([data UTF8String], crypto::HEX);
    
    return [NSString stringWithUTF8String:hex.base64().c_str()];
}
...
+ (NSDictionary *)generateCSR:(NSString *)companyID deviceID:(NSString *)deviceID deviceType:(NSString *)deviceType
{
    ...
    auto csr = CSR::generate_csr(rsa, [companyID UTF8String], [deviceID UTF8String], [deviceType UTF8String]);
    if( !csr.empty() )
    {
        auto privateKey = CSR::getPrivate(rsa);
        if( !privateKey.empty() )
        {
            return @{ @"CSR": [NSString stringWithUTF8String:csr.c_str()], @"key": [NSString stringWithUTF8String:privateKey.c_str()] };
        }
    }
